...
typedef size_t (*cio_buf_read_func_t)(cio_buf_istream_t *self, uint8_t *buf, size_t len, size_t timeout);
typedef size_t (*cio_buf_write_func_t)(cio_buf_ostream_t *self, const uint8_t *buf, size_t len, size_t timeout);
